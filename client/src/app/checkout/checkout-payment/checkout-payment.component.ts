...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe("pk_test_51OqooyHqnKvsUjNgl4kpKkHuF6rRfB1juFiuCEebBKimdUeEl5bGXNdvxKGgcuB8QafORecmOWZbdXCb5ejHr9e90061UnFcGV")
      .then(stripe => {
        this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    if (basket == null) throw new Error('Basket is null');
